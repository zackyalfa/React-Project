...
export default function Login() {
    ...
    const handleLogin = (event) => { // ketika event terjadi javascript akan meberikan respon 
        ...
        axios.post('http://localhost:6666/login', values)
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleLogin} className="space-y-4 md:space-y-6">
                            ...
                            <button onClick="/proffil" type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                Login
                            </button>
                        </form>
                    </div>
