...
export default function ModalDelete({ isOpen, closeModal, endpoints, coloumnDetail }) {
    ...
    return (
        <>
            ...
            <div id="popup-modal" tabindex="-1" class="fixed top-0 left-0 w-full h-full flex items-center justify-center">                <div class="relative p-4 w-full max-w-md max-h-full">
